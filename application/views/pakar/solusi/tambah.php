...
?>
	...
	<div class="col-md-5">
	<input type="text" name="id_solusi" class="form-control"placeholder="ID Solusi" value="<?php echo set_value('id_solusi') ?>" required>
	</div>
	</div>
	...
	<div class="col-md-5">
	<textarea type="text" name="solusi" class="form-control"placeholder="Solusi" value="<?php echo set_value('solusi') ?>" required></textarea>
